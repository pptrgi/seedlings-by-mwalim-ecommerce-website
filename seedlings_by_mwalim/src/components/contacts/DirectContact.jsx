        ...
        <form ref={form} onSubmit={sendEmail}>
          <div className='flex flex-col space-y-4 items-center'>
            <div className='flex flex-col space-y-1 items-start w-full'>
              <label className='text-smallerFontSize text-textColor font-normalWeight'>Name</label>
            ...
            <div className='flex flex-col space-y-1 items-start  w-full'>
              <label className='text-smallerFontSize text-textColor font-normalWeight'>Email</label>
            ...
            <div className='flex flex-col space-y-1 items-start  w-full'>
              <label className='text-smallerFontSize text-textColor font-normalWeight'>Your Message</label>
