        ...
        <div className='container flex flex-col justify-between items-center pt-[4rem] pb-[6rem] lg:items-start lg:h-0 lg:flex-row'> 
            <div className='flex flex-col items-center'>
                ...
                <div className='flex justify-center items-center space-x-1 sm:space-x-2 py-[1rem]'>
                    <img src={seedlingsLogo} className='w-28 h-[3rem]' alt="" />
                    <img src={LipaNaMpesaLogo} className='w-36 h-[4rem]' alt="" />
                </div>
            </div>
            <div className='flex justify-between items-start w-full sm:w-1/2 lg:w-1/3 xl:w-1/5'>
                <div className='flex flex-col items-start'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <a href="#products" className='text-titleColor'>Vegetables</a>
                    </div>
                </div>
                <div className='flex flex-col items-start'>
                    <h4 className='font-mediumWeight text-normalFontSize mb-[0.75rem]'>QUICK LINKS</h4>
                    <div className='flex flex-col gap-2'>
                        <Link to='/contacts' className='text-titleColor'>Contact</Link>
                        <Link to='/login' className='text-titleColor'>Login</Link>
                        <Link to='/cart' className='text-titleColor'>Cart</Link>  
                        <Link to='/' className='text-titleColor'>Home</Link>  
                    </div>
                </div>
            </div>
            <div className='flex flex-col gap-6 md:gap-[3rem] mt-[2rem]'>
                <div className='flex flex-row justify-center space-x-4 sm:space-x-4 '>
                  <a href="https://twitter.com/ptrgitonga"><BsTwitter size={18} className='text-titleColor'/></a>
                  <a href="https://wa.me/254700119134"><BsWhatsapp size={18} className='text-titleColor'/></a>
                  <a href="https://www.facebook.com/pptrgitonga"><BsFacebook size={18} className='text-titleColor'/></a>
                </div>
